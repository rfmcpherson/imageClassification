...
def main():
    ...
    # Normal images
    #condor("norm", path+"mnist-data/norm/")

    # P3 images
    #condor("p3-1", path+"mnist-data/p3-1/")
    #condor("p3-10", path+"mnist-data/p3-10/")
    #condor("p3-20", path+"mnist-data/p3-20/")

    # Pixelated images
    condor("pix-2", path+"mnist-data/pix-2/")
    #condor("pix-4", path+"mnist-data/pix-4/")
    #condor("pix-8", path+"mnist-data/pix-8/")
    condor("pix-16", path+"mnist-data/pix-16/")
